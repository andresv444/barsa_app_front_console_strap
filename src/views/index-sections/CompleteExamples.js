          ...
          <Row className="justify-content-md-center">
            <Col lg="8" md="12">
              ...
              <h5 className="description">
                ...
                You can change the text and images and you're good to go. More
                importantly, looking at them will give you a picture of what you can built
                with this powerful Bootstrap 4 ui kit.
              </h5>
            </Col>
          </Row>
        </Container>
